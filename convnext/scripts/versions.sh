...
echo "timm $(echo 'import timm; print(timm.__version__)' | python3)"
echo "tensorboardX $(echo 'import tensorboardX; print(tensorboardX.__version__)' | python3)"
echo "submitit $(echo 'import submitit; print(submitit.__version__)' | python3)"
